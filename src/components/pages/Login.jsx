...
import {login,getMenu,getCeshi} from '../../api/auth'
...
class Login extends React.Component {
    ...
    ///测试
    handleSubmitsCeshi=(e)=>{
        let params = {
            name:'20561885-588f-4af1-8c3d-840a56eb34dd'
        }
        getCeshi(params).then(res=>{
            debugger
        })
    }
    getUserName=(data)=>{
                ...
                <div className="login-form" >
                    ...
                    <Form style={{maxWidth: '300px'}}>
                        ...
                        <Form.Item>
                            ...
                            <Button type="primary" htmlType="submit" className="login-form-button" style={{width: '100%'}} onClick={(e)=>this.handleSubmitsCeshi(e)}>
                                测试
                            </Button>
                            <div style={{textAlign: 'right'}}>
                                <span className="login-form-forgot" onClick={this.onGoVideoPage}>小视屏</span>
                            </div>
